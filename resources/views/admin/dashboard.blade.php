...
@section('content')
    ...
    <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('admin.orders.index') }}">Lihat Semua Pesanan &rarr;</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 mb-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-danger">Stok Menipis (< 10)</h6>
                </div>
                <div class="card-body">
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('admin.products.index') }}">Kelola Produk &rarr;</a>
                    </div>
                </div>
            </div>
        </div>
